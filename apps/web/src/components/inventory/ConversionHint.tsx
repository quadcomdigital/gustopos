...
export default function ConversionHint({ conversions, canonicalUnit }: ConversionHintProps) {
  ...
  return (
    <div className="relative group/conversion tabular-nums">
      ...
      <div className="absolute bottom-full right-0 mb-1 w-max max-w-[160px] px-2 py-1 rounded bg-gray-900 text-white text-[10px] shadow-lg opacity-0 group-hover/conversion:opacity-100 transition-opacity pointer-events-none z-10">
        {conversions.map((c) => (
