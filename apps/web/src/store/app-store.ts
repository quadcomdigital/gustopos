...
interface AppState {
  ...
  addBomComponent: (id: string, payload: { componentType: 'ingredient' | 'bom'; componentId: string; quantity: number; unit: string }) => Promise<void>;
  removeBomComponent: (id: string, payload: { componentType: 'ingredient' | 'bom'; componentId: string }) => Promise<void>;
  ...
  addMenuItemRecipeComponent: (id: string, payload: { componentType: 'ingredient' | 'bom'; componentId: string; quantity: number; unit: string }) => Promise<void>;
  removeMenuItemRecipeComponent: (id: string, payload: { componentType: 'ingredient' | 'bom'; componentId: string }) => Promise<void>;
