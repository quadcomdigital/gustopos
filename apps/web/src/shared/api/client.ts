...
async function authorizedFetch(url: string, init?: RequestInit, retried = false, existingIdempotencyKey?: string): Promise<Response> {
...
export async function addBomComponent(id: string, payload: { componentType: 'ingredient' | 'bom'; componentId: string; quantity: number; unit: string }): Promise<BomItem> {
...
export async function removeBomComponent(id: string, payload: { componentType: 'ingredient' | 'bom'; componentId: string }): Promise<BomItem> {
...
export async function addMenuItemRecipeComponent(
  id: string,
  payload: { componentType: 'ingredient' | 'bom'; componentId: string; quantity: number; unit: string },
): Promise<MenuItemAdmin> {
...
export async function removeMenuItemRecipeComponent(
  id: string,
  payload: { componentType: 'ingredient' | 'bom'; componentId: string },
): Promise<MenuItemAdmin> {
